<script>
  ...
  const links = [
    ...
    { id: 1, href: "/", name: "My Files", icon: "/icons/folders.svg" },
    ...
    { id: 4, href: "/", name: "Profile", icon: "/icons/profile.svg" },
  ];
</script>

<ul class="absolute h-full w-full flex justify-center inset-0 gap-12">
  {#each links as link}
    <Tooltip.Provider>
      <Tooltip.Root >
        <Tooltip.Trigger>
